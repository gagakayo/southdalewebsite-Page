...
<body>
    <div class="container">
        <h1>Elementary Grade Levels</h1>

        <!-- BSIT Course -->
        <div class="course" id="course-garnet">
            <h2 onclick="toggleCourse('course-garnet')">Grade-1 : GARNET</h2>
        ...
        <!-- BSCS Course -->
        <div class="course" id="course-amthys">
            <h2 onclick="toggleCourse('course-amthys')">Grade-2 : AMETHYST</h2>
            <div class="description">
        ...
        <!-- BSBA Course -->
        <div class="course" id="course-aquam">
            <h2 onclick="toggleCourse('course-aquam')">grade-3 : AQUAMARINE</h2>
            <div class="description">
        ...
        <!-- BSBA Course -->
        <div class="course" id="course-diamond">
            <h2 onclick="toggleCourse('course-diamond')">grade-4 : DIAMOND</h2>
            <div class="description">
                <p>Learn the ins and outs of business management, marketing, finance, and entrepreneurship. This course prepares students for leadership roles in various industries and equips them with practical business skills.</p>
            </div>
            <div class="enroll">
        ...
        <!-- BSBA Course -->
        <div class="course" id="course-emerald">
            <h2 onclick="toggleCourse('course-emerald')">grade-5 : EMERALD</h2>
            <div class="description">
                <p>Learn the ins and outs of business management, marketing, finance, and entrepreneurship. This course prepares students for leadership roles in various industries and equips them with practical business skills.</p>
            </div>
            <div class="enroll">
        ...
        <!-- BSBA Course -->
        <div class="course" id="course-pearl">
            <h2 onclick="toggleCourse('course-pearl')">grade-6 : PEARL</h2>
            <div class="description">
                <p>Learn the ins and outs of business management, marketing, finance, and entrepreneurship. This course prepares students for leadership roles in various industries and equips them with practical business skills.</p>
            </div>
            <div class="enroll">
