...
<body>
    <div class="container">
        ...
        <!-- BSIT Course -->
        <div class="course" id="course-bsit">
            <h2 onclick="toggleCourse('course-bsit')">BSIT - Bachelor of Science in Information Technology</h2>
        ...
        <!-- BSCS Course -->
        <div class="course" id="course-bscs">
            <h2 onclick="toggleCourse('course-bscs')">BSCS - Bachelor of Science in Computer Science</h2>
            <div class="description">
        ...
        <!-- BSBA Course -->
        <div class="course" id="course-bsba">
            <h2 onclick="toggleCourse('course-bsba')">BSBA - Bachelor of Science in Business Administration</h2>
            <div class="description">
        ...
        <!-- BSED Course -->
        <div class="course" id="course-bsed">
            <h2 onclick="toggleCourse('course-bsed')">BSED - Bachelor of Science in Education</h2>
            <div class="description">
