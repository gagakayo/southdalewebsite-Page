...
<body>
    <div class="container">
        <h1>Grade 12 - EARTH, VENUS & JUPITER</h1>

        <!-- BSIT Course -->
        <div class="course" id="course-bsit">
            <h2 onclick="toggleCourse('course-bsit')">HUMSS</h2>
        ...
        <div class="course" id="course-bscs">
            <h2 onclick="toggleCourse('course-bscs')">ABM</h2>
            <div class="description">
        ...
        <div class="course" id="course-bsba">
            <h2 onclick="toggleCourse('course-bsba')">STEM</h2>
            <div class="description">
        ...
        <div class="course" id="course-bsed">
            <h2 onclick="toggleCourse('course-bsed')">GAS</h2>
            <div class="description">
