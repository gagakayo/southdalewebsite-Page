...
<body>
    <div class="container">
        <h1>Primary Grade- Levels</h1>

        <!-- BSIT Course -->
        <div class="course" id="course-bsit">
            <h2 onclick="toggleCourse('course-bsit')">Nursery : POSEIDON</h2>
        ...
        <div class="course" id="course-bscs">
            <h2 onclick="toggleCourse('course-bscs')">Kinder : APHRODITE</h2>
            <div class="description">
        ...
        <div class="course" id="course-bsba">
            <h2 onclick="toggleCourse('course-bsba')">Preparatory : ZEUS</h2>
            <div class="description">
