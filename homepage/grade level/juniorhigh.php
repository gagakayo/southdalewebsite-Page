...
<head>
    ...
    <title>Junior High School Levels</title>
...
<body>
    <div class="container">
        <h1>Junior High Grade Levels</h1>

        <!-- BSIT Course -->
        <div class="course" id="course-bsit">
            <h2 onclick="toggleCourse('course-bsit')">Grade-7 : RUBY</h2>
        ...
        <div class="course" id="course-bscs">
            <h2 onclick="toggleCourse('course-bscs')">Grade-8 : SAPPHIRE</h2>
            <div class="description">
        ...
        <div class="course" id="course-bsba">
            <h2 onclick="toggleCourse('course-bsba')">grade-9 : OPAL</h2>
            <div class="description">
        ...
        <!-- BSBA Course -->
        <div class="course" id="course-bsba">
            <h2 onclick="toggleCourse('course-bsba')">grade-10 : TURQUOISE</h2>
            <div class="description">
                <p>Learn the ins and outs of business management, marketing, finance, and entrepreneurship. This course prepares students for leadership roles in various industries and equips them with practical business skills.</p>
            </div>
            <div class="enroll">
